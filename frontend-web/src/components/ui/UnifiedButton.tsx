...
export const UnifiedButton: React.ForwardRefRenderFunction<HTMLButtonElement, ButtonProps> = (
  {
    className,
    variant = 'filled',
    size = 'md',
  ...
  return (
    <button
      ...
      className={classNames(
        ...
        transitionClasses,
        focusClasses,
        isIconOnly ? iconSizeClasses[size as keyof typeof iconSizeClasses] : sizeClasses[size as keyof typeof sizeClasses],
...
export const UnifiedIconButton: React.FC<ButtonProps> = (props) => {
  const { children, ...restProps } = props;
  return (
    <UnifiedButton isIconOnly {...restProps} />
  );
};
